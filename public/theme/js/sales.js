...
$('#AddExpense').click(function (e) {
  ...
  var base_url=$("#base_url").val().trim();
   ...
   //Validate Input box or selection box should not be blank or empty
    ...
    check_field("invoice_no");

    check_field("delivery_date");

    check_field("delivery_person");
    check_field("total_expense_amt");
  ...
  //Atleast one record must be added in sales table 
    ...
    //end
        ...
        if($("#expense_amount").val()==''){
          ...
          toastr["warning"]("Please Enter the Expense Amount!!");
        ...
        if($("#expense_type").val()==''){
          ...
          toastr["warning"]("Please Enter the Expense Type!!");
 ...
 if($("#delivery_date").val()==''){
          ...
          toastr["warning"]("Please Enter the Deliver Date!!");
    ...
    var this_id=this.id;
      ...
      //if(confirm("Do You Wants to Save Record ?")){
        ...
        url: base_url+'sales/sales_save_expense?command='+this_id,
...
function sales_type_approve(id,status){
...
function edit_payment(sales_id,payment_id){
	var base_url=$("#base_url").val().trim();
// alert(base_url+'sales/show_edit_now_modal');
  $.post(base_url+'sales/show_edit_now_modal', {sales_id:sales_id,payment_id: payment_id}, function(result) {
...
function update_payment(payment_id){
  ...
  var base_url=$("#base_url").val().trim();
   ...
   //Validate Input box or selection box should not be blank or empty
    ...
    $.post(base_url+'sales/update_payment', {payment_id: payment_id,sales_id:sales_id,payment_type:payment_type,amount:amount,payment_date:payment_date,payment_note:payment_note,cheque_no:cheque_no,cheque_date:cheque_date,paid_status:paid_status}, function(result) {
