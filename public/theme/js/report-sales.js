...
$("#view_ledger,#view_all").click(function(){
    ...
    if(from_date == "")
     ...
     if(to_date == "")
        ...
        $(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
        $.post("show_sales_report_ledger",{customer_id:customer_id,view_all:view_all,from_date:from_date,to_date:to_date},function(result){
          //alert(result);
            setTimeout(function() {
             $("#tbodyid").empty().append(result);     
             $(".overlay").remove();
