...
$(document).ready(function(){
  ...
  {
//document.getElementById("service_none").style.display = 'none';
   ...
   //Validate Input box or selection box should not be blank or empty
    ...
    var this_id=this.id;
        ...
        $("#"+this_id).attr('disabled',true);  //Enable Save or Update button
				...
				url: base_url+'quotation/quotationtosales?command='+this_id+'&rowcount='+rowcount+'&tot_subtotal_amt='+tot_subtotal_amt+'&tot_discount_to_all_amt='+tot_discount_to_all_amt+'&tot_round_off_amt='+tot_round_off_amt+'&tot_total_amt='+tot_total_amt+"&other_charges_amt="+other_charges_amt,
   ...
   //Validate Input box or selection box should not be blank or empty
    ...
    var this_id=this.id;
        ...
        $("#"+this_id).attr('disabled',true);  //Enable Save or Update button
				...
				url: base_url+'quotation/sales_save_and_update?command='+this_id+'&rowcount='+rowcount+'&tot_subtotal_amt='+tot_subtotal_amt+'&tot_discount_to_all_amt='+tot_discount_to_all_amt+'&tot_round_off_amt='+tot_round_off_amt+'&tot_total_amt='+tot_total_amt+"&other_charges_amt="+other_charges_amt,
...
function update_approved(id)
{
	...
	$.post("quotation/update_approved",{id:id},function(result){
		if(result=="success")
				{
					 toastr["success"]("Status Updated Successfully!");
				  //alert("Status Updated Successfully!");
...
function return_row_with_data(item_id){
  ...
  $("#item_search").addClass('ui-autocomplete-loader-center');
	...
	$.post(base_url+"quotation/return_row_with_data/"+rowcount+"/"+item_id,{},function(result){
...
document.getElementById("item_search").readOnly = true;
    ...
    $.post(base_url+"quotation/return_row_with_servicedata/"+rowcount,{},function(result){
...

{
   ...
   if(confirm("Do You Wants to Delete Record ?")){
    ...
    $.post("quotation/delete_sales",{q_id:q_id},function(result){
...
function save_approval(sales_id){
  ...
  var base_url=$("#base_url").val().trim();
    ...
    $.post('quotation/save_approval', {sales_id: sales_id,po_date:po_date,po_number:po_number}, function(result) {
       result=result.trim();
         if(result=="success")
          ...
          if(confirm("Do You Wants to Save Record ?")){
            ...
            success: function(result){
              ...
              if(result=="success")
              {
                ...
                window.location=base_url+'quotation/add';//"items-view.php";
                return;
              }
              else if(result=="failed")
              {
