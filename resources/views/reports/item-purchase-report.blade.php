    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-0 text-gray-800">Item Purchase Report</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="#">Reports</a></li>
                            <li class="breadcrumb-item active">Item Purchase Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover" id="item-purchase-report-table">
                                ...
                                <tr>
                                    <td colspan="8" class="text-center py-4">
                                        <div class="text-muted">
                                            ...
                                            <p>Click "Show" to load item purchase data</p>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center py-4">
                ...
                <p class="mt-2 mb-0">Generating Item Purchase Report...</p>
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    function generateReport() {
        ...
        // Make AJAX request
        $.ajax({
            url: '{{ route("reports.item-purchase-report") }}',
            method: 'GET',
            data: {
                from_date: fromDate,
                to_date: toDate,
                ...
                <tr>
                    <td colspan="8" class="text-center py-4">
                        <div class="text-muted">
                            ...
                            <p>No item purchase records found for the selected criteria</p>
                        </div>
                    </td>
                </tr>
            `);
    ...
    $('#export-excel').click(function() {
        var table = document.getElementById('item-purchase-report-table');
        var wb = XLSX.utils.table_to_book(table, {sheet: "Item Purchase Report"});
        var fileName = 'Item-Purchase-Report-' + $('#from_date').val() + '-to-' + $('#to_date').val() + '.xlsx';
