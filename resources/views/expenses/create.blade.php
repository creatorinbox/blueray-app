...
<div class="page-header">
    <h1 class="page-title">
        <i class="fas fa-money-bill-wave me-2"></i>Expense
    </h1>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- Vehicle Number -->
                            <div class="form-group mb-3" id="vehicle_section" style="display:none">
                                ...
                                <input type="text" class="form-control" id="vehicle_no" name="vehicle_no" 
                                       value="{{ old('vehicle_no') }}" placeholder="Enter vehicle number">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" id="vat_type" name="vat_type" onchange="vatcal()">
                                    <option value="withoutvat" {{ old('vat_type') == 'withoutvat' ? 'selected' : '' }}>Without VAT</option>
                                    <option value="vat" {{ old('vat_type') == 'vat' ? 'selected' : '' }}>VAT</option>
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" id="note" name="note" rows="4" 
                                          placeholder="Enter expense notes">{{ old('note') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('#category_id').on('change', function() {
        ...
        if (categoryId) {
            ...
            // Show/hide vehicle section based on category (you can customize this logic)
            if (categoryId == '8') { // Assuming transport/vehicle category has ID 8
