...
<div class="page-header">
    <h1 class="page-title">
        <i class="fas fa-edit me-2"></i>Edit Expense Subcategory
        <small class="text-muted">Update Subcategory Information</small>
    </h1>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('expense-sub-categories.update', $subCategory->id) }}" method="POST" id="subCategoryForm">
                    @csrf
                    @method('PUT')
                    <div class="row">
